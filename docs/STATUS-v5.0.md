...
文書ID: STATUS-v5.0 | 更新日: 2026-03-04 (v5.2.1)
...
**Sprint 1: 手触り強化 (+4点: 操作性+2, 音響+1.5, コアループ+0.5)**
- [ ] ヒットストップ (攻撃命中時 3-5F停止)
- [ ] 敵被弾ノックバック (16px) + 白フラッシュ (0.1秒)
- [ ] SE接続 (assets/se/ 14種mp3をイベントに紐付け)
- [ ] 攻撃命中時のパーティクル強化

**Sprint 2: マップ多様性 (+2点: ランダム生成+2)**
- [ ] 部屋テンプレート5種 (開放/迷路/環状/L字/十字)
- [ ] 環境ギミック1種 (トゲ床)
- [ ] generateRoom関数の置換

**Sprint 3: ビルド多様性 (+2点: コアループ+1.5, 敵デザイン+0.5)**
- [ ] 祝福を24種に拡張 (各系統4つ)
...
**Sprint 5: メタ基盤 (+2点: メタ+2)**
- [ ] ネクター (永続通貨) 基本実装
- [ ] 死亡時ネクター獲得表示
- [ ] 花壇メニュー (HP+1, ATK+1 の2種のみ)
