...
| Sprint 4 | ビジュアル/スプライト | +3 | 🔧 エンジン実装済, 画像生成待ち |
...
| 課題 | 優先度 | 備考 |
|---|---|---|
| Sprint 4: スプライト画像生成 | 高 | GCP課金設定が必要, APIキーのfree_tier制限解除待ち |
| Geminiバッチプリセット更新 (33種) | 高 | sprite-generator.html のENEMY_PRESETS拡張 |
