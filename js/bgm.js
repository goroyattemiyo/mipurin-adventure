...
function playBGM(name, fadeIn) { ChipBGM.play(name, fadeIn); }
function stopBGM(fadeDur, cb) { ChipBGM.stop(fadeDur, cb); }
function fadeOutBGM(dur, cb) { ChipBGM.fadeOut(dur, cb); }
