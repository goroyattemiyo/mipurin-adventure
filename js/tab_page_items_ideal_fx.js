// ===== js/tab_page_items_ideal_fx.js =====

function drawItemsPageIdealFx() {
  const ui = drawTabBaseV2(0, '持ち物 | 1-3: アイテム / ESC: とじる');
  ...
  drawTabUiSparkles(lowerCols.right, 8, ['#ffd700', '#fff8e1', '#f9a8d4']);
