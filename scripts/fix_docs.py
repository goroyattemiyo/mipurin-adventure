...
pathlib.Path("STATUS.md").write_text(status, encoding="utf-8")
...
pathlib.Path("ROADMAP.md").write_text(roadmap, encoding="utf-8")
print("[OK] ROADMAP.md updated")

# === Update module sizes in STATUS.md with actual values ===
import os
files = [
    "js/game.js", "js/data.js", "js/bgm.js", "js/charms.js",
    "js/enemies.js", "js/blessings.js", "js/systems.js", "js/nodemap.js",
    "js/equip_ui.js", "js/ui.js", "js/ui_screens.js", "js/combat.js",
    "js/update.js", "js/render.js", "js/touch.js"
]
print("\n--- Actual file sizes ---")
for f in files:
    if os.path.exists(f):
        sz = os.path.getsize(f) / 1024
        print(f"  {f}: {sz:.1f} KB {'OK' if sz < 30 else 'OVER!'}")
    else:
        print(f"  {f}: NOT FOUND")
